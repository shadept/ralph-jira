      ...
      return (
        <div className="flex h-64 flex-col items-center justify-center gap-3 text-center">
          ...
          <p className="text-sm text-muted-foreground max-w-md">
            Choose a project from the header to generate tasks and insights with AI.
          </p>
        </div>
      );
    }
      ...
      <div className="mx-auto space-y-6 max-w-4xl">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Describe a feature or requirement, and AI will generate actionable tasks
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm text-muted-foreground">
            <p>More AI actions are available directly on boards and tasks:</p>
